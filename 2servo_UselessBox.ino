...
void setup()
{
  ...
  handServo.write(180);   //начальное положение сервы руки
  boxServo.write(70);    //Исходное положение серводвигателя, открывающего коробку
}
